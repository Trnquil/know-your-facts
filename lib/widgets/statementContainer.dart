...
class StatementContainerState extends State<StatementContainer> {
  ...
  Widget build(BuildContext context) {
        ...
        text: TextSpan(children: [
          ...
          TextSpan(
              ...
              style: TextStyle(
                  ...
                  fontWeight: FontWeight.bold)),
          TextSpan(
              text: (dateFormatDate.format(
                  widget.statement.date?.toLocal() ?? DateTime.utc(1970))),
              style: TextStyle(
                  fontSize: 12,
                  color: Colors.black45,
                  fontWeight: FontWeight.bold))
        ...
        Container(
          ...
          decoration: BoxDecoration(
            ...
            color: widget.statement.isFactual
                ? Colors.green.shade200.withOpacity(0.5019607843137255)
                : Color.fromRGBO(243, 137, 137, 0.5019607843137255),
          ),
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  Text(
                    widget.statement.isFactual ? "Factual" : "Debatable",
                    style: TextStyle(
                      fontSize: 30,
                      fontWeight: FontWeight.bold,
                      color: widget.statement.isFactual
    ...
    return Stack(alignment: Alignment.bottomCenter, children: [
      _card(
          widgetsTop: mainWidgets,
          widgetsBottom: showMoreWidgets,
          button: button),
    ]);
  }
...
class _card extends StatelessWidget {
  const _card(
      ...
      required this.widgetsTop,
      required this.widgetsBottom,
